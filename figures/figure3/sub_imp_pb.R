df <- read.csv("sub_imp_pb.csv", stringsAsFactors = FALSE)
...
setEPS()
postscript("sub_imp_pb.eps", width=10, height=7)
...
mtext("Power balance (including Trump effect)", side = 1, line = 3, cex = 2)
